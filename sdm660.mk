...
PRODUCT_COPY_FILES += \
    ...
    $(COMMON_PATH)/configs/sysconfig/preinstalled-packages-platform-asus-product.xml:$(TARGET_COPY_OUT_PRODUCT)/etc/sysconfig/preinstalled-packages-platform-asus-product.xml \
